...
const HomePage: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Dashboard background with gradient + pattern */}
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-amber-500/5 blur-[120px]" />
      </div>
      <div className="relative z-10 flex h-full w-full flex-col min-h-0 min-w-0 max-w-full">
        ...
        <div className="flex-1 flex min-h-0 overflow-hidden">
          ...
          >
            ...
            {!marketReviewReport && isLoadingReport ? (
              ...
              <div className="space-y-4 pb-8 min-h-0 min-w-0 overflow-y-auto overflow-x-hidden h-full">
