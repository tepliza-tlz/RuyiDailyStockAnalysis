      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="pointer-events-none absolute -bottom-10 -right-10 z-0 opacity-[0.08]"
          >
            <svg viewBox="0 0 320 80" className="h-[40vh] w-auto" fill="currentColor" opacity="0.7">
              <text x="0" y="40" fontFamily="'Microsoft YaHei',sans-serif" fontSize="60" fontWeight="700">如意金股</text>
              <text x="0" y="60" fontFamily="'Segoe UI',Arial,sans-serif" fontSize="20" fontWeight="400" letterSpacing="1">RuyiDailyStockAnalysis</text>
            </svg>
          </motion.div>
          ...
          >
            ...
            <span>如意金股 V3 QUANTITATIVE SYSTEM</span>
          </motion.div>
        </motion.div>
