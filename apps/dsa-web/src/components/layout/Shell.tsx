...
export const Shell: React.FC<ShellProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto flex h-dvh w-full min-h-0 overflow-hidden px-3 py-3 sm:px-4 sm:py-4 lg:px-5">
        <aside
          className={cn(
        ...
        <main className="min-h-0 min-w-0 flex-1 overflow-hidden pt-14 lg:pl-3 lg:pt-0 touch-pan-y">
          {children ?? <Outlet />}
        </main>
      </div>
